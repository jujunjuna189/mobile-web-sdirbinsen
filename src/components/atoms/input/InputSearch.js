...
const InputSearch = (props) => {
    ...
    return (
        <div className="flex gap-2 items-center w-full">
            <div className="rounded-md shadow-md flex bg-white items-center border gap-1 flex-grow pl-3">
                ...
                <input type="text" className="py-3 px-3 text-sm w-full m-0 focus:outline-none rounded-md placeholder:text-slate-500 font-semibold" placeholder={props.placeholder} value={controller} onChange={(event) => onChanged(event)} />
            </div>
            {/* <div>
