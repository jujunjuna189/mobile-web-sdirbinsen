        ...
        <Content>
            ...
            <div className="absolute top-0 bottom-0 left-0 right-0 overflow-y-auto">
                ...
                <div className="grid md:grid-cols-3 grid-cols-2 gap-5 px-3 mt-6 justify-center">
                    {getLocalUser()?.permission?.["view.learning.alutsista-armed"] && (
                    ...
                    {getLocalUser()?.permission?.["view.learning.tugas-tanggung-jawab"] && (
                    ...
                    {getLocalUser()?.permission?.["view.learning.hasil-litbang"] && (
                    ...
                    {getLocalUser()?.permission?.["view.learning.prioritas-renbut"] && (
                    ...
                    {getLocalUser()?.permission?.["view.learning.program-tot-tok"] && (
                    ...
                    {getLocalUser()?.permission?.["view.learning.roadmap-siapsat-armed"] && (
                    ...
                    {getLocalUser()?.permission?.["view.learning.gelar-satuan-armed"] && (
                        <div className="rounded-md bg-gradient-to-r from-[#A49F1D] via-[#FFFDBC] to-[#CFB20E] p-[0.20rem]" onClick={() => navigation(RouterName.bukuPintarList, { state: { title: "Renbanglarsat Armed", category: "renbanglarsat-armed" } })}>
                            <div className="h-full bg-[#4B7D5E] flex flex-col justify-between">
                                ...
                                <div className="text-center mt-2">
                                    <strong className="text-[#D6D156] font-black" style={{ textShadow: "0px 1px 3px #000000" }}>Gelar Satuan Armed</strong>
                                </div>
                            </div>
                        </div>
                    )}
