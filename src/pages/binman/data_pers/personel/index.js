...
const BinmanPersListPage = () => {
    const { location, personil, onSearch } = UseBinmanPersContext();
    return (
        <Content>
            ...
            <div className="absolute top-0 bottom-0 left-0 right-0 overflow-y-auto">
                ...
                <div className="sticky top-0 z-10 bg-black pb-2">
                    ...
                    <div className="flex gap-3 mt-3 px-3">
                        <InputSearch onChange={(value) => onSearch({ value: value })} placeholder="Cari Personel..." />
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-2 flex flex-col">
                                            <span className="text-white font-bold" style={{ textShadow: "0px 1px 3px #000000" }}>NRP: {item.nrp}</span>
                                            <span className="text-white font-bold" style={{ textShadow: "0px 1px 3px #000000" }}>Satuan: {item.satuan?.nama}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
