...
const BinmanPetaJabatanPage = () => {
    const { navigation, satuan, onSearch } = UseBinmanPetaJabatanContext();
                ...
                <div className="my-2 px-3 flex justify-center items-center">
                    ...
                    <div className="absolute pb-2">
                        ...
                        <div className="text-center">
                            <strong className="text-[#D6D156] font-black text-2xl" style={{ textShadow: "0px 1px 3px #000000" }}>PETA JABATAN</strong>
                        </div>
                    </div>
                </div>
...
export default BinmanPetaJabatanPage;